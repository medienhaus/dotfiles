...
" color scheme name
let g:colors_name = "untitled_faded"
...
hi DiffChange            ctermfg=159         ctermbg=235         cterm=none
...
hi CursorLineNr          ctermfg=229         ctermbg=235         cterm=none
...
hi Question              ctermfg=229         ctermbg=none        cterm=none
...
hi StatusLineR          ctermfg=204         ctermbg=235         cterm=none
hi StatusLineG          ctermfg=193         ctermbg=235         cterm=none
hi StatusLineB          ctermfg=159         ctermbg=235         cterm=none
hi StatusLineY          ctermfg=229         ctermbg=235         cterm=none
...
hi WarningMsg            ctermfg=234         ctermbg=229         cterm=none

"hi Whitespace           ctermfg=            ctermbg=            cterm=

hi WildMenu              ctermfg=234         ctermbg=229         cterm=none
...
hi Type                  ctermfg=147         ctermbg=none        cterm=none
...
hi Error                 ctermfg=231         ctermbg=204         cterm=none

hi Todo                  ctermfg=229         ctermbg=240         cterm=none

" -- Diagnostic highlights -- `:help diagnostic-highlights` --------------------

hi DiagnosticError       ctermfg=204         ctermbg=235         cterm=none
hi DiagnosticWarn        ctermfg=229         ctermbg=235         cterm=none
hi DiagnosticInfo        ctermfg=159         ctermbg=235         cterm=none
